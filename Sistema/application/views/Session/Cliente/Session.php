...
<html lang="pt-br">
    ...
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" type="text/css" href="css/style_session.css?v=11" >
            ...
            <div class="conteiner-aside">
                ...
                <aside>
                    <nav id="nav-aside" class="nav-aside hide-aside" >
                        ...
                        <ul>
                            <a href="#"><li><i class="fa fa-home"></i><span>Inicio</span></li></a>
            ...
            <div class="conteiner-article">
                ...
                <article>
                    ...
                    <div class="article">
                        ...
                        <div class="body-article" style="text-align: center; line-height:25px;">
                            <p><strong>Nome:</strong><?php echo '   '.$this->session->userdata('NOME'); ?></p>
                            <p><strong>Nome de Usuário:</strong><?php echo '   '.$this->session->userdata('USUARIO'); ?></p>
                        </div>
