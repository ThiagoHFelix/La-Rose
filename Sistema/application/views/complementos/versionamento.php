...
<style type="text/css">
    ...
    .content-versionamento { box-sizing: border-box; z-index:300; width:300px; height:100px;  position:fixed; background: rgba(0,0,0,1); bottom:5px; left:5px; display:none; }
    ...
    #fechar { width:300px; height:100px; position:fixed; text-align: center; padding-top:15px; transition: 0.2s;}
...
<div id="janela-versionamento" class="content-versionamento">
    ...
    <div id="fechar"> <span id="text-fechar" style="color:#fff;">Fechar</span> </div> 
