...
<html lang="pt-br">
    <head>
        ...
        <title>Project-X | Salão de Beleza</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="cabeçalho" >
            ...
            <div class="logo"><a href="index.php"><h1>Project-X</h1></a></div>
        ...
        <div class="banner">
            ...
            <p> <i class="logo-sm">Project-X</i>é um salão de cabeleireiro que atende tanto homens quanto mulheres <br/>Venha nos Conhecer</p>
        ...
        <footer class="rodape">
            ...
            <div class="redes-sociais">
                <ul>
                    ...
                    <li ><a href="#"></a><i class="fa fa-comment" aria-hidden="true"></i></li>
                    <li ><a href="#"></a><i class="fa fa-copyright fa-lg"></i></li>
                    <li ><a href="#"></a><i class="fa fa-car fa-lg"></i></li>
                    <li ><a href="#"></a><i class="fa fa-book fa-lg"></i></li>
                </ul>
            </div>
            
            <div class="direitos-autorais">
                <p>Copyright © 2017, Project-X. Todos os direitos reservados.</p>
            </div>
